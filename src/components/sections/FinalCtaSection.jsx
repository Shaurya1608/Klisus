      ...
      <div className="relative w-full rounded-[24px] sm:rounded-[32px] md:rounded-[40px] bg-gradient-to-b from-[#e6eff9] via-[#e2edfa] to-[#dae7f6] border border-blue-200/80 shadow-[0_8px_30px_rgba(15,23,42,0.04)] px-5 sm:px-10 md:px-16 lg:px-20 py-10 sm:py-16 md:py-18 text-center overflow-hidden transition-all duration-500 hover:border-blue-300/90 hover:shadow-[0_12px_36px_rgba(37,99,235,0.06)]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-5 sm:space-y-7">
          ...
          <div className="pt-3 sm:pt-4 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <a
              href="#partner"
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 px-7 py-3 sm:py-3.5 rounded-full bg-white text-slate-950 text-xs sm:text-sm font-semibold uppercase tracking-wider border border-blue-200/90 hover:bg-slate-950 hover:text-white hover:border-slate-950 transition-all duration-300 shadow-md group min-h-[44px]"
            >
            ...
            <a
              href="#contact"
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 px-7 py-3 sm:py-3.5 rounded-full bg-blue-50/90 text-blue-950 border border-blue-200/90 text-xs sm:text-sm font-semibold uppercase tracking-wider hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-300 shadow-sm group min-h-[44px]"
            >
              <Mail className="w-4 h-4 text-blue-700 group-hover:text-white transition-colors" />
